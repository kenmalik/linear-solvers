...
The `profile` directory contains a script `nsys-profile.sh` that produces a CSV file containing a runtime summary of NVTX-marked sections of the program. Running this script requires NVIDIA's Nsight Systems to be installed.
